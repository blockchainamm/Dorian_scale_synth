# Program to generate the sounds of notes of a dorian scale matching the frequencies of notes in piano
...
def load_notes(notestep, notestep1, notescale):
    ...
    # Interval of notes for a dorian scale
    notes_interval = [2, 1, 2, 2, 2, 1, 2, 1] 
    rev_interval = [0, 2, 1, 2, 2, 2, 1, 2]
    tones_fwd, tones_rev = [], []
    
    print(f'The frequencies in Hz of ascending notes for {notescale} in the dorian scale')
    ...
    print()
    print(f'The frequencies in Hz of descending notes for {notescale} in the dorian scale')
    ...
    # Return list of frequencies in the ascending and descending notes of the dorian scale    
...
# Scale list for which the dorian scale will be played in sequence
scale_list = ['C4']
